...
/**
 * @file
 * Contains Drupal\messagerie\Form\AddCommentReplyContactForm
 */
 ...
 * Class AddForm.
 *
 * @package Drupal\messagerie\Form\AddCommentReplyContactForm
 */
class AddCommentReplyContactForm extends FormBase {
  ...
  public function getFormId() {
    return 'messagerie_comment_reply_contact_add';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $arg = NULL) {
    global $base_url;
    $usern = MessagerieStorage::getUserInfo($arg);
    $form = array(
        ...
        'destinatarie' => [
          ...
          '#default_value' => $usern->username.' ('.$arg.')',
        ],
        'subject' => array(
          '#type' => 'textfield',
        ...
        /*'submit' => array(
          ...
          '#ajax'  => array(
            'url' => Url::fromRoute('messagerie.save.comment.contact'),
          ),
        ),*/
