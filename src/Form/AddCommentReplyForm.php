...
/**
 * @file
 * Contains Drupal\messagerie\Form\AddCommentReplyForm
 */
 ...
 * Class AddForm.
 *
 * @package Drupal\messagerie\Form\AddCommentReplyForm
 */
class AddCommentReplyForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state, $arg = NULL) {
    ...
    $form = array(
        ...
        'submit' => array(
          ...
          '#ajax'  => array(
            'url' => Url::fromRoute('messagerie.save.comment.reply'),
          ),
        ),
